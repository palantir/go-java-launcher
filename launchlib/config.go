...
type ExperimentalLauncherConfig struct {
	...
	// AllowHeapShrink, when true, omits the minimum heap size flag (-Xms or -XX:InitialRAMPercentage),
	// allowing the JVM to start with a small heap and grow/shrink dynamically.
